...
p.buttonbox = 1; % set to 0 for use of keyboard, to 1 for use of button box
...
p.experimentcode = fileread('runexperiment_Practice.m');
...
for eventnr=1:nevents
    ...
    if isrunstart
        ...
        instructiontext = sprintf('Block %i/%i\n\n%s\n\nPress space to continue the experiment', currentrun, nruns, questiontext);
